...
def score(age,hoursinlast6hours,hoursperweek):
  from azureml.api.schema.dataTypes import DataTypes
  from azureml.api.schema.sampleDefinition import SampleDefinition
  from azureml.api.realtime.services import generate_schema
  import pandas
  
  #df = pandas.DataFrame(data=[[age,hoursinlast6hours,hoursperweek]], columns=[age,hoursinlast6hours,hoursperweek])
  ...
  init()
  input1 = pandas.DataFrame([[age,hoursinlast6hours,hoursperweek]])
